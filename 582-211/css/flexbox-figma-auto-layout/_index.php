...
<grostitre>L'auto-layout dans Figma</grostitre>
...
<dots></dots>
<grostitre>Flexbox via l'auto-layout et le Dev&nbsp;mode dans Figma</grostitre>
...
<dots></dots>
<p><a href="https://www.figma.com/design/iUiwmQrCE7wneBx6k1OpZO/flexbox-demo" target="_blank"
        rel="noopener noreferrer">FICHIER DE DEMO</a></p>

<info>
    <p>
        Pour mieux comprendre l'auto-layout et son lien avec le principle de flexbox, veuille <strong>afficher les
            libellés dans les panneau de configuration de Figma</strong></p>
...
<h3>🛠️ Démonstration 1: cadre de texte dynamique et bouton en <em>auto-layout</em></h3>
<checklist>
...
<!-- Réduire encore largeur du bouton plus petit que le texte et observer comment le texte s'ajuste à la taille du bouton. S'ajuste-t-il? Non. 
    Pensez flexbox. S'il n'y a pas assez de place en largeur <incode>flex-direction: row;</incode>, que devriez-vous ajouter afin que le texte excédentaire continue suer une 2e ligne en dessous? Réponse: <incode>flex-wrap: wrap;</incode>
    Comment activer ce comportement dans l'outil auto-layout de Figma? Ici:  -->

<dots></dots>

<grostitre>Le panneau auto-layout dans Figma</grostitre>
