...
<!--
<h3>Ordre d’empilage</h3>
<p>Un élément HTML peut contenir d’autres éléments. L'élément enfant s’affiche par-dessus son parent. Ainsi, la fin de la chaîne se retrouvera sur le dessus, alors que celui au début se retrouvera en dessous.</p>
...
<info>Contrairement à <incode>padding</incode>, <incode>margin</incode> accepte les valeurs négatives.</info>
...
<info>Remarquez comment l’image <img src="https://tim-montmorency.com/timdoc/shared/images/square.png" alt="" style="display: inline; margin: 0; width: 100px"> se répête par défaut.</info>
...
<codepen id="jOpZRag" tab="result,css" height="340">À gauche, un dégradé linéaire. À droite, un dégradé radial.</codepen>
...
<codepen id="poZaBKv" tab="result,css" height="340">À gauche, deux image se superposent. À droite, une image et un dégradé se superposent.</codepen>
...
<codepen id="yLqvrZe" tab="result,css" height="340">À gauche, l’image se répète. À droite, l’image ne s’affiche qu’une seule fois.</codepen>
...
<codepen id="bGjLJXb" tab="result,css" height="340">À gauche, l’image se répète à l’horizontale. À droite, l’image se répète à la verticale.</codepen>
...
<codepen id="WNKMBvv" tab="result,css" height="340"></codepen>
...
<codepen id="bGjLXKJ" tab="result,css" height="340">À gauche, l’image est déformée. À droite, l’image est redimensionnée proportionnellement.</codepen>
...
<codepen id="zYLRgJN" tab="result,css" height="340">À gauche, l’image est entièrement visible. À droite, l’image est rognée, mais couvre entièrement son élément.</codepen>
...
<p>Sauf s'ils sont stylisés autrement, nativement, les éléments de type <em>bloc</em> tels que les balises <incode><div></incode>, <incode><p></incode>, <incode><ul></incode>, <incode><li></incode>, <incode><article></incode>, <incode><section></incode>, <incode><header></incode> etc., s'affichent un en dessous de l'autre dans la balise parent qui les contiennent.</p>
<info>
Autrement dit: 
  <blockquote>
    <p>« Les éléments de type bloc sont <em>disposés l'un après l'autre, verticalement</em>, en débutant tout en haut de l'élément parent qui les contiennent. La distance verticale entre deux blocs voisins est déterminée par leur marges.</p>

    <p>Pour chaque élément de type bloc, le côté gauche de l'élément touche le côté gauche de son parent. Même chose pour le côté droit. »</p></blockquote>
  <small>Traduction libre de : <a href="https://www.w3.org/TR/CSS2/visuren.html#normal-flow" target="_blank" rel="noopener noreferrer">9.4.1 Block formatting contexts - W3C </a></small>
</info>
<dots></dots>

<h3>Affichage d'un élément de type en ligne (inline)</h3>
<p><p>Sauf s'ils sont stylisés autrement, nativement, les éléments de type <em>en ligne</em> tels que les balises <incode><span></incode>, <incode><em></incode>, <incode><strong></incode>, <incode><i></incode> etc., s'affiche sur la même ligne que l'élément précédent ou suivant dans un flot horizontal.</p>
...
<p>Comme il est mentionné à la rubrique <a href="#le-flux-natif-de-la-page-html">Le flux natif de la page HTML</a>, le flux normal aussi appelé <em>“flow”</em> en anglais, est la façon dont les éléments sont affichés dans une page web lorsqu’aucun style ne leur est appliqué.</p>
...
Je vous conseille donc de toujours débuter vos feuilles de style avec cette ligne !
</warning>
