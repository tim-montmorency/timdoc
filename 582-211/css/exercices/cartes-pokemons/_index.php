...
/**
 * @type     exercice
 * @title    Cartes dompteurs de Pokemons
 * @icon     images/thumb.jpg
 * @abstract Pour cet exercice vous allez reproduire des cartes de domppteurs de Pokemons
 */
?>


<p>Pour cet exercice vous allez reproduire des cartes de domppteurs de Pokemons</p>
...
<h3>Fichiers</h3>
<doclink href="./dossier-depart-pokemons.zip">Dossier de départ</doclink>

<h3>Couleurs 🎨</h3>

<table class="table-couleurs">
    <tr>
        <td>Arrière plan des cartes</td>
        <td>
            <color>#323243</color>
        </td>
    </tr>
    ...
    <tr>
        <td>Couleur du survol du bouton</td>
        <td>
            <color>#0095b3</color>
        </td>
    </tr>
...
<alert>Vous ne pouvez PAS changer le HTML. Vous devez écrire que dans la fichier <em>styles.css</em> qui est actuellement vide.</alert>
...
<p>Tout le contenu est couvert par notre <a href="../../../wiki/" target="_blank" rel="noopener noreferrer">Wiki cours 1 à 5.</a>.</p>
