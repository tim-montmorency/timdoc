...
<clipasset src="./videos/apercu-2025-v2-compressed.mp4"></clipasset>
<br> Démo du survol:
...
<checklist>
  Positionnez en absolu la balise image dont la source est <span class="inline-code">photo-bg.webp</span>. Assurez-vous  qu'elle prenne tout l'espace disponible sur l'affiche en largeur et en hauteur.
  À l'aide de propriétés comme <span class="inline-code">object-fit</span>, faites-en sorte que l'exédentaire (bref ce qui dépasse du cadre) soit rogné <em>(cropped)</em> et que la partie <strong>inférieure-gauche</strong> de l'image ne soit jamais rognée <em>(cropped)</em>.
