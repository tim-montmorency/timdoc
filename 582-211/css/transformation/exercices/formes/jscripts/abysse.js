var popup = new AppendPopup({
    ...
    text: "Félicitation, vous maîtrisez les scales",
    color: "#f4ff48",
    background: "https://media2.giphy.com/media/XaLnoepP2IwFnUXdvb/giphy.gif?cid=790b76118bd0a1d1594a3d7893facacdefee4a31f777f02f&rid=giphy.gif",
...
body {
    ...
    background-image: url(https://tim-montmorency.com/timdoc/582-215MO/css/transformation/exercices/formes/images/abysse.png);
}
.slide {
    width: 200px;
    height: 200px;
...
var validate = debounce(function () {
    var s1 = validateSlide(red, '-100', '-100', 0, '2', '2');
    if(s1) {
        var s2 = validateSlide(blue, '-100', '-100', 0, '1.0', '1.0');
        if(s2) {
            var s3 = validateSlide(green, '-100', '-100', 0, '0.5', '0.5');
            if(s3) {
