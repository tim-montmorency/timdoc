 ...
 * @abstract Configurer GitHub pour un projet
 */
?>

<p class="spacer">Il est possible d'utiliser GitHub pour travailler à plusieurs sur le même projet Unity. Ici nous verrons comment configurer votre projet.</p>

<dots></dots>

<grostitre>Étapes résumées</grostitre>
...
<p>Une fois que votre projet est prêt, vous pouvez le modifier en même temps. Avant de faire un commit, appuyez toujours sur Fetch Origin, si Pull apparaît, vous devez faire un Pull. Ensuite, vous pourrez faire votre commit, puis le push.</p>

<alert> L'ordre est toujours Pull, puis Push!!</alert>
