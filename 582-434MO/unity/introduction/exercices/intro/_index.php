...
/**
 * @type     exercice
 * @title    Exercice d'introduction à Unity
 * @icon     images/icon.png
 * @abstract Navigation, objets, outils, ... 
 */
?>

<p class="spacer">Cet exercice vous permettra de vous familiarisez avec la navigation et la création d'objets dans Unity.</p>
...
<grostitre>Ouvrir le projet dans Unity</grostitre>
<checklist>
