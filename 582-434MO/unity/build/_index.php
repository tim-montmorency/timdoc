 ...
 * @abstract Créer une application
 */
?>

<p class="spacer">Dans Unity, il est possible d'exporter son jeu pour pouvoir y jouer sans ouvrir le projet dans Unity. On peut exporter le jeu pour différentes plateformes, PC, IOS, Android,...</p>


<dots></dots>

<grostitre>Préparer l'exportation</grostitre>
<p>Peu importe la plateforme sur laquelle on crée notre build, certaines étapes sont à respecter.</p>
<checklist>
...
<grostitre>Exporter pour PC, MAC, Linux</grostitre>
<checklist>
...
<grostitre>Exporter pour Android</grostitre>
<checklist>
