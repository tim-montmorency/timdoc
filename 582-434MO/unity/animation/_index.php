...
/**
 * @type     article
 * @title    Animation objets 2D
 * @icon     images/icon.png
 * @abstract Animation de sprite sheet
 */
?>
...
<grostitre>Création d'animations de paramètres de GameObject</grostitre>
<p>Une fois l'animator créé, on est prêt à animer l'objet sur lequel il est ou ses enfants. On peut animer n'importe quel paramètre de cet objet.</p>
<checklist>
...
<grostitre>Création d'animations de Sprite Sheet</grostitre>
