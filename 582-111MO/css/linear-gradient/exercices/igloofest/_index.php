...
/**
 * @type     exercice
 * @title    Linear-gradient - Igloofest
 * @icon     images/thumb.jpg
 * @abstract Pour cet exercice, vous devez compléter la mise en page d’un carton promotionnel de l’Igloofest.
 */
?>

<p class="spacer">Pour cet exercice, vous devez compléter la mise en page d’un carton promotionnel de l’<a target="_blank" href="https://igloofest.ca/fr">Igloofest</a>.</p>

<p>Aperçu du résultat 👇</p>

<img src="images/background-igloofest-resultat.jpg">
