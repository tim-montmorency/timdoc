...
<checklist>
    ...
    De façon similaire au précédent menu déroulant, créez-en une nouvelle div, mais cette fois-ci pour le mois de naissance de l'usager et configurer ses attributs <span class="inline-code">name</span> et <span class="inline-code">id</span> à <span class="inline-code">month</span>, afin de pouvoir y faire référence en back-end.<br><br>Attribuer cette fois à chaque option une valeur allant de 1 à 12, mais afficher les noms complets de chaque mois afin de simplifier la vie à l'utilisateur.
    Créer une dernière <em>div</em> avec un menu déroulant permettant à l'usager de choisir son année de naissance. Les attributs <span class="inline-code">name</span> et <span class="inline-code">id</span> doivent avoir la valeur <span class="inline-code">year</span> et les options doivent aller de 2007 jusqu'à 1980. <em>(Les valeurs et les textes affiché sont les mêmes)</em>
