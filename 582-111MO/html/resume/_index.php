...
<ul>
  <li><em>&lt;div&gt; &lt;/div&gt;</em> : bloc de texte – généralement utilisé pour découper un document
en bloc. </li>
<li><em>&lt;span&gt; &lt;/span&gt;</em> : la balise <span> est un conteneur en ligne.</li>
</ul>
...
<grostitre>Balises de texte</grostitre>

<ul>
  <li><em>&lt;p&gt;&lt;/p&gt;</em> : paragraphe </li>
  <li><em>&lt;br&gt;</em> : saut de ligne</li>
  <li><em>&lt;hr&gt; </em>: ligne horizontale</li>
</ul>
...
<grostitre>Balises de formatage</grostitre>
...
<ul>
  ...
  <li><em>&lt;li&gt;&lt;/li&gt;</em>: définit les différents élements de la liste</li>
</ul>
...
<highlight lang="html">&lt;a href=&quot;https://www.google.ca&quot;&gt;Google&lt;/a&gt;</highlight>
...
<grostitre>Tableau structuré</grostitre>
...
<ul>
  ...
  <li><em>&lt;tbody&gt;&lt;/tbody&gt;</em>: : indique que c’est le corps tableau </li>
...
<grostitre>Fusion de cellules</grostitre>
...
<ul>
  <li><em>&lt;img&gt;</em> : indique que l’on va insérer une image </li>
  <li><em>src</em> : indique source de l’image (i.e. où se trouve l’image) </li>
  <li><em>alt</em> : indique un texte alternatif pour décrire l’image </li>
  <li><em>height</em> et <em>width</em> : hauteur et largeur de l’image</li>
</ul>
...
<ul>
  <li>La balise <em>&lt;figure&gt;</em> permet d'associer un élément (image, vidéo, diagramme, etc.)</li>
  <li>La légende de la figure utilise la balise <em>&lt;figcaption&gt;</em></li>
</ul>

<img src="./images/figcaption.webp">
...
<ul>
  <li><em>&lt;audio&gt;&lt;/audio&gt;</em> : indique l’insertion d’un élément de type audio</li>
  <li>Attribut de base : <em>src</em> : source de l’audio </li>
...
<ul>
  <li><em>&lt;video&gt;&lt;/video&gt;</em> : indique l’insertion d’un élément de type video</li>
  <li>Attribut de base : <em>src</em> : source de la vidéo </li>
