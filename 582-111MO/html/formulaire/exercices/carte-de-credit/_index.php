...
<checklist>
    Premièrement, créer une forme avec la classe <em>"form"</em> ainsi que l'action écrite ci-dessus.
    À l'intérieur de la forme, ajouté 2 <em>div</em>.
    Dans la première <em>div</em> (numéro de carte de crédit), ajouter un champ texte avec l'id : credit-card-number.
    ...
    Une <em>div</em>, doit avoir la classe : colonne1 et l'autre la classe : colonne2.
    La première <em>div</em> (date d'expiration), est un champ texte avec un id : expiry-date.
    La deuxième (code de sécurité de la carte) est aussi un champ texte avec un id : security-code.
    ...
    Les champs de date d'expiration et de code de sécurité doivent affichez les textes indicatifs <em>"10/24"</em> et <em>"123"</em>.
