...
<p>La balise <incode>&lt;aside&gt;</incode> est utilisée pour contenir du contenu qui est lié de manière indirecte au contenu principal de la page. Par exemple, dans un article, le <incode>&lt;aside&gt;</incode> pourrait contenir des informations supplémentaires, des citations, des publicités, ou des liens vers des articles connexes.</p>

<h2>Exemple simple</h2>
<p>Dans un article sur les chats, un <incode>&lt;aside&gt;</incode> pourrait inclure une petite section sur les meilleures marques de nourriture pour chats. Ce n'est pas le sujet principal, mais c'est lié et peut être intéressant pour le lecteur.</p>

<h2>En résumé</h2>
<ul>
  <li><b>Contenu secondaire </b>: Le contenu de <incode>&lt;aside&gt;</incode> est lié, mais pas essentiel, au contenu principal.</li>
  <li><b>Exemples d'utilisation</b> : Informations supplémentaires, liens connexes, citations, publicités.</li>
</ul>
