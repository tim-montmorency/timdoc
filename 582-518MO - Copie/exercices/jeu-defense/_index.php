...
La zone principale de votre interface doit être une <em>grille CSS</em> de 3 colonnes de large par 4 rangées de haut, ayant un espace vide de 20px verticalement ↕️ entre chaque rangée.
...
*/
?>
<!-- version 2024 avec composante (je ne trouve plus le corrigé) -->
...
Utilisez une propriété calculée se basant sur le nombre de points de défense du joueur afin d'afficher l'image du chevalier appropriée. <br><br>Par exemple, lorsque le joueur à 0 point de défense, l'image <incode>https://tim-montmorency.com/timdoc/582-518MO/exercices/jeu-defense/images/0.png</incode>, où le chevalier n'a aucune pièce d'armure, devrait être affiché. <br><br>À l'opposée, si le chevalier à 7 points de défense, l'image avec l'armure complète <incode>https://tim-montmorency.com/timdoc/582-518MO/exercices/jeu-defense/images/7.png</incode> devrait être affichée.
...
Lorsque cliqué, l'aperçu d'une pièce d'armure doit se voir ajouter la classe <em>"is-active"</em> changeant ainsi son apparence <em>(voir les requis CSS)</em>. Ceci devra être syncronisé avec la propriété booléenne <em>wearing</em> déjà existante.
Utilisez des propriétés calculées afin d'afficher en temps réel le nombre de points de défense ainsi que le poids total des pièces d'armure lorsqu'elles sont ajoutées/retirées. Attention, seules les pièces ajoutées permettent d'obtenir des <em>points de défense</em> et comptent dans le <em>poids total</em>.
