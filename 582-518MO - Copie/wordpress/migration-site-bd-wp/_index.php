...
<dots></dots>
<grostitre>Depuis l'ordinateur vers lequel vous migrez WP</grostitre>
<ol start="3">
...
<warning>Si le problème persiste, il est possible que votre navigateur vous redirige toujours vers <span class='inline-code'>localhost:81/abc</span> même si vous tapez <span class='inline-code'>localhost/abc</span>. Si tel est le cas, vous devez vider le cache de votre navigateur. Pour développer votre débrouillardise, je vous laisse trouver comment le faire, vous avez les outils pour y parvenir.</warning>
