...
<wiki-page name="Cours 01" date="2024-01-21">
    ...
    <ul>
        ...
        <li>Activité brise-glace: <a href="https://app.wooclap.com/JDESOE" target="_blank" rel="noopener noreferrer">Code Wooclap: JDESOE</a> </li>
        <li>Test diagnostique de vos connaissances en HTML, CSS et JavaScript: <a href="https://app.wooclap.com/POLDQO" target="_blank" rel="noopener noreferrer">Code Wooclap: POLDQO</a> </li></li>
    </ul>
