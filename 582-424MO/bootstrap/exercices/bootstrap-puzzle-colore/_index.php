...
/**
 * @type     exercice
 * @title    Bootstrap - Puzzle coloré
 * @icon     images/thumb.png
 * @abstract Pour cet exercice, vous devez ...
 */
?>

<p class="spacer">Pour cet exercice, vous devrez recréer plusieurs mise en page existante à l’aide de la grille Bootstrap</p>

<grostitre>Matériel</grostitre>

<doclink href="https://codepen.io/tim-momo/pen/vYadgvZ">Pen de départ</doclink>

<warning>Vous n’avez qu’à modifier le HTML <em>(nul besoin de modifier le CSS ou le JavaScript)</em>.</warning>

<p>Bootstrap 5 est déjà inclus dans le Pen.</p>
...
Étape 5: Recréez l'affichage suivant en respectant les changements de mise en page apparaissant aux breakpoints <code>md</code> et <code>xl</code>. À partir de cette étape, vous aurez besoin des <a target="_blank" href="../../grille/#rangees">options d'alignement des rangées</a> afin de réussir certains exercices. <img src="images/bootstrap-ex05.png">
...
Étape 8: Recréez l'affichage suivant en respectant le changement de mise en page apparaissant au breakpoint <code>md</code>. Afin de réussir cette 
mise en page, vous devrez vous aventurer dans <a href="https://getbootstrap.com/docs/5.0/layout/columns/#order-classes" target="_blank">la documentation de Bootstrap</a> afin de vous renseigner à propos d'<code>order</code>. <img src="images/bootstrap-ex08.png">
Étape 9: Recréez l'affichage suivant en respectant les changements de mise en page apparaissant aux breakpoints&nbsp;<code>md</code> et <code>xl</code>. Afin de réussir cette mise en page, vous devrez vous aventurer dans <a href="https://getbootstrap.com/docs/5.0/layout/columns/#offsetting-columns" target="_blank">la documentation de Bootstrap</a> afin de vous renseigner à propos d'<code>offset</code>. <img src="images/bootstrap-ex09.png">
</checklist>
