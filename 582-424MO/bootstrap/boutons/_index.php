...
<p>À la base, les classes <em>.btn</em> sont conçues pour être utilisées avec l'élément <em>&lt;button&gt;</em>. ​</p>
...
<p>À la base, les classes <em>.btn</em> sont conçues pour être utilisées avec l'élément <em>&lt;button&gt;</em>. Cependant, vous pouvez également utiliser ces classes sur des éléments <em>&lt;a&gt;</em> ou <em>&lt;input&gt;</em>.</p>
...
<p>Vous avez besoin d'un bouton, mais pas des couleurs d'arrière-plan pleines? Remplacez les classes de modificateur par défaut par <em>.btn-outline-…</em></p> 
...
<p>Envie de boutons plus grands ou plus petits ? Ajoutez <em>.btn-lg</em> ou <em>.btn-sm</em> pour des tailles supplémentaires.​</p>
