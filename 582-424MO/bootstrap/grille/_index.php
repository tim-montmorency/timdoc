...
<p>Les colonnes ou en anglais&nbsp;<em>columns</em>&nbsp;sont les composantes les plus importantes de la grille&nbsp;Bootstrap! Elle permettent de définir la dimension allouée aux différents éléments sur la&nbsp;page.</p>
...
<p>Par exemple, des colonnes prenant toute la largeur sur mobile pourrait n'avoir qu'une demi-largeur à partir d'une taille d'écran égale ou supérieur à&nbsp;<code>md</code>.</p>
