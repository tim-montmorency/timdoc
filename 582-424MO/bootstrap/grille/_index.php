...
<codepen id="WNKyvyN" tab="result" height="300"></codepen>
...
<codepen id="WNKyvgb" tab="result" height="300"></codepen>
...
<codepen id="ExpRjev" tab="result" height="300"></codepen>
...
<codepen id="BaPVNEB" tab="html,result" height="300"></codepen>
...
<codepen id="RwBJPmd" tab="html,result" height="300"></codepen>
...
<codepen id="KKBepjg" tab="html,result" height="300"></codepen>


<br><br>
<p>Toutes les options de largeur de 1 à 12 sont disponibles.</p>
<img src="images/bootstrap-columns.png" class="full">
...
<codepen id="WNKyvVr" tab="html,result" height="300"></codepen>
...
<codepen id="dyjKoxg" tab="html,result" height="300"></codepen>
