 ...
 */
?>
<p>Les points d'arrêt <em>(breakpoints)</em> sont des largeurs personnalisables qui déterminent le comportement de votre mise en page réactive en fonction de la taille des périphériques ou des fenêtres d'affichage dans Bootstrap.</p>

<p>Afin de bien comprendre la grille Bootstrap, il est impératif de connaitre ses&nbsp;breakpoints.</p>
