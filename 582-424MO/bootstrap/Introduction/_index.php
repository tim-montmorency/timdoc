...
<p>Bootstrap est le cadriciel <em>(framework)</em> de mise en page le plus populaire au monde. Il permet de simplifier
    et d'accélérer la réalisation de sites web responsives.</p>
