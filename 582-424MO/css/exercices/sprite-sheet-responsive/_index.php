...
<p>Pour cet exercice, vous devez faire ajuster la taille de l'animation de la spritesheet pour qu'elle s'ajuste à 50% de la largeur de la fenêtre.</p>
...
<checklist>
  ...
  Ensuite, dans la définition de l'animation elle même, ajustez le background-position final pour qu'il soit aussi en pourcentage. Notez qu'il y a 19 images dans la spritesheet et que chaque image sont de dimension originale de 700px par 700px;
</checklist>