...
Stylisez la carte comme vous le souhaitez par la suite, tant que les conditions précédentes sont remplies. Aussi ajoutez un effet hover sur la carte. Lorsque vous êtes satisfait, vous pouvez dupliquer la première carte dans les 2 autres colonnes et ajuster son contenu pour les différentes œuvres. 
...
Ajustez le contenu de toutes vos cartes en y insérant les infos réelles 6 œuvres que vous avez sélectionnées en équipes, soient 3 en vedette et 3 dans la section autres.
</checklist>
