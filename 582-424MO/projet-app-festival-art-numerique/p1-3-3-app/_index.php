...
<checklist>Enlevez le style width : 140% que vous avez appliqué sur votre section et ajoutez-lui un overflow : hidden.
Avant ou après la row qui contient vos col et card, ajoutez le HTML de mise en page Swiper.
Requis du swiper : pas de bouton précédent ou suivant, pas de pagination, pas de scrollbar.
Ajoutez la classe <em>.swiper-featured-artworks</em> ce swiper.
Sortez les cards de votre grille Bootstrap et amenez les dans les slides swiper, un par slide.
