...
Dans la 2e rangée, créez 6 colonnes de largeur identique. Par défaut, les colonnes s’affichent sur toute la largeur de la rangée. À partir du breakpoint <em>sm</em>, on verra 2 colonnes par rangée. À à partir du breakpoint <em>lg</em>, on verra 4 colonnes par rangée., donc la 2e rangée de carte témoignage n’en contiendra que 2, trouvez un moyen de les centrer dans leur propre rangé. 
