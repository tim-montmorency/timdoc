...
Sur toutes les sections de votre page (et il y en aura d’autres à venir), assurez-vous d’avoir un <incode>padding</incode> en haut et en bas assez large pour laisser respirer le contenu. Assurez-vous aussi que ce <incode>padding</incode> est constant de section en section. Utilisez les classes utilitaires Boostrap pour générer ce <incode>padding</incode>. 
