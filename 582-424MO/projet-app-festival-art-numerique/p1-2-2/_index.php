...
<checklist>
    ...
    À partir du breakpoint sm, la navbar doit affichée une barre de navigation complète.
...
À partir du breakpoint de votre choix entre md, lg ou xl, ces 2 colonnes se déploient l'une à coté de l'autre et leur contenu n'est plus centré, il sera aligné à gauche.
...
<checklist>
    ...
    À ta navBar, ajoute une photo de profil de la personne qui est connectée à l'appli. Cette photo peut-être stylisée commme vous le voulez (ronde, carré etc), elle doit se placer à droite de la navBar.
    La navbar doit être toujours figée en haut de la page, peut-importe le défilement.  
</checklist>
