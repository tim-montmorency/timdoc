...
<checklist>Créez une nouvelle section Voir plus (view-more) et insérez la juste après la section fonctionnalité et juste avant.  Ajoutez-lui un id. 
...
Ajustez dans Photoshop afin que chaque image de vos impressions-écran aient la meêm dimension en pixel. Prenez le temps d'optimiser le poids de vos images, exportez-les en jpg et compressez un peu.
...
Toujours dans l’initialisation de swiper dans votre fichier script.js,ajoutez les propriétés nécessaire pour les requis suivants:<br>- Par défaut (mobile) on veut voir une seule slide à la fois<br>- dès le breakpoint 1200px, on veut voir 3 slides à la fois.<br>- les images dans les slides doivent être centrée dans celles-c<br>- le carrousel doit être infini, c’est dire que lorsqu’on atteint la dernière slide, on continue à la première.<br>- on doit activer les boutons suivants et précédent
Finalement, ajoutez des styles afin que les 2 slides de cotés soient semi-transparente et que celle qui est active, au centre, ne soit pas transparente.
