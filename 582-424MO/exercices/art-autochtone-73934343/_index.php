...
<p>Vous pouvez aussi contrôler la vidéo de l'aperçu via <a href="https://cmontmorency365-my.sharepoint.com/:v:/g/personal/mariem_ouellet_cmontmorency_qc_ca/EastFmeNwtZMp1BbMQWN9cQBVHrgpsZ_QPVrk9EHqHdMTg?e=bvlK6d" target="_blank">ce lien vers vidéo </a></p>
...
Ajoutez les classes Bootstrap pour:<br>- Changer d'affichage vers la navigation complète à partir du breakpoint <incode>MD</incode><br>- Changer l'arrière-plan de la navbar pour du foncé (dark)<br>- Ajuster le thème de couleur de la navbar de sorte que le texte soit facilement lisible.<br>- La barre de navigation doit toujours être positionnée en haut de la page, peu importe le défilement de celle-ci.
...
Ajoutez une balise <incode>main</incode> SOUS la balise <incode>header</incode>. Dans <incode>main</incode>, ajoutez 3 <incode>section</incode> une en dessous de l'autre, avec les <incode>id</incode> suivants: hero, presentation, actualite (sans accent).
...
Conservez la classe <incode>.swiper</incode> sur le parent du carrousel.
...
Stylisez le carrousel <incode>.swiper</incode> en CSS pour lui donner une hauteur de 45 pourcent de la hauteur du <em>Viewport Height</em> et une largeur maximum de 1700px.
...
<checklist>
Dans la section<incode>#presentation</incode> que vous avez préalablement créée, ajoutez les balises et classes nécessaires pour une grille de mise en page Bootstrap de 4 colonnes.
...
<checklist>
Dans la section<incode>#actualite</incode> que vous avez préalablement créee, ajoutez les balises et classes nécessaires pour une grille de mise en page Bootstrap: une rangée d'une seule colonne qui inclura le titre et une autre rangée qui contiendra 3 colonnes et une dernière rangée d'une seule colonne qui contiendra le bouton "Toute l'actualité>>".
