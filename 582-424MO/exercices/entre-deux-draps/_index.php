...
<doclink
    href="https://fonts.google.com/specimen/Poppins?preview.text_type=custom&preview.text=Vous%20%C3%AAtes%20capable,%20vous%20allez%20r%C3%A9ussir!">
    Police Poppins</doclink>

<warning>Les propriétés CSS <incode>position</incode> et <incode>transform</incode> seront inutiles. La mise en page sera réalisée entièrement grâce&nbsp;à&nbsp;Bootstrap.</warning>
...
Changez d'affichage&nbsp;vers la navigation complète à partir du breakpoint&nbsp;<incode>lg</incode>.
...
<checklist>Le fond doit-être un&nbsp;dégradé&nbsp;vers le bas partant de bleu foncé&nbsp;vers&nbsp;bleu 🔵.
    Par défaut, l'image&nbsp;<incode>noovo.webp</incode> 🌄&nbsp;dans le dossier&nbsp;<incode>img</incode>&nbsp; 📁 doit prendre toute la largeur.
    ...
    À partir du breakpoint&nbsp;<incode>lg</incode>&nbsp;le texte et l'image doivent être juxtaposés un à côté de l'autre.
...
<checklist>Doit avoir un fond&nbsp;blanc.
    ...
    Utilisez une balise <incode>picture</incode> afin d'afficher par défaut l'image&nbsp;<incode>college-logo-vertical.png</incode> 🌄. À partir de 576px de large, la source de cette image doit-être remplacé par l'image&nbsp;<incode>college-logo-horizontal.png</incode>.
</checklist>
...
<checklist>Cette&nbsp;section&nbsp;doit avoir un fond&nbsp;de couleur noir charbon ⚫️ et avoir un espace vide de 30px dans le haut et le&nbsp;bas.
    ...
    Chaque&nbsp;carte&nbsp;doit prendre toute la largeur par défaut. À partir du breakpoint&nbsp;<incode>md</incode>&nbsp;elles doivent prendre la moitié et à partir de&nbsp;<incode>lg</incode>&nbsp;le&nbsp;tier.
...
Par défaut les textes&nbsp;<em>"TIM Montmorency"</em>&nbsp;et&nbsp;<em>"© 2021"</em>&nbsp;doivent être centrés un au-dessus de l'autre. À partir du breakpoint&nbsp;<incode>sm</incode>, ils doivent être affichés un à côté de l'autre. Le 1<sup>er</sup>&nbsp;aligné complètement à gauche et le 2<sup>e</sup>&nbsp;complètement à&nbsp;droite.
</checklist> -->
...
<checklist>Renommez votre dossier de travail 📁 au
    format&nbsp;suivant:<br><incode>[nom de famille]_[prénom]_entre-deux-draps</incode><br>ex:
