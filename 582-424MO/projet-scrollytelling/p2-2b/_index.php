...
Assurez-vous que la tailles de vos images soit responsive. <em>Voir ci-bas pour les instructions en détails.</em>
...
<ul>
    ...
    <li>
        <h4>2- Assurez-vous que la tailles de vos images soit responsives.</h4>
