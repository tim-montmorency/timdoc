...
<ul>
    <li>
        <p>De le télécharger sur le&nbsp;<a href="https://gsap.com/docs/v3/Installation/?checked=core%2CmotionPath&tab=cdn&module=esm&method=private+registry&tier=free&club=false&require=false&trial=true&plugins=MotionPathPlugin#grab-the-files" target="_blank">site de&nbsp;GSAP</a> et l'installer dans votre propre projet.</p>
    </li>
    <li>
        <p>D'utiliser un&nbsp;<a href="https://gsap.com/docs/v3/Installation/?checked=core%2CmotionPath&tab=cdn&module=esm&method=private+registry&tier=free&club=false&require=false&trial=true&plugins=MotionPathPlugin#install-helper"  target="_blank">Content Delivery Network (CDN)</a> (onglet CDN), comme vous avez l'habitude de faire. Vous devez y cocher la boîte à cocher du plugiciel <em>MotionPath</em>, et plus bas, aller copier les 2 balises <span class='inline-code'>script</span> générées (une pour le coeur de gsap et l'autre pour le plugiciel MotionPath) et les coller dans votre/vos page(s) HTML qui contiendront des animations GSAP.</p>
    </li>

    <li>De partir des&nbsp;<a href="https://codepen.io/GreenSock/full/23d3979528b262cb07da37f6a7c7dd76" target="_blank">gabarits de base CodePen</a>. Vous devez copier le lien de GSAP Core et celui de <em>MotionPath</em> et, sur votre CodePen via <em>Settings/JS/Add External Scripts</em>, y coller successivement les liens.</li>
</ul>
