...
<checklist>
    ...
    Ajoutez la classe <span class='inline-code'>.bg-warning</span> à la balise <span class='inline-code'>nav</span> pour que l'arrière plan soit turquoise comme l'exemple donné ci-haut.
