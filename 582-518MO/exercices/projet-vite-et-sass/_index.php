...
<alert>Pour cet exercice, ne PAS compiler avec l'extention <em>Live Sass Compiler</em> ni utiliser le <em> hot relead</em> de l'extension <em>Live Server</em> (Go Live). Tout sera géré via le serveur de développement Vite.</alert>
