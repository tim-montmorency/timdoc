...
<mediafile src="images/bg.jpeg">Image 1</mediafile>
...
Utilisez une boucle <code>@each</code> afin de générer des noms de classes ciblant chacun des personnages suivants: <em>echo, genji, hanzo, junkrat, lucio, mccree, mercy, moira, orisa, pharah, reaper, reinhardt</em>
Pour chacun de ces personnages, ajouter une image d'arrière-plan dont le chemin de fichier correspond à: <code>https://ex.smnarnold.com/scs/overwatch/[nom du personnage].jpg</code> et assurez que cette image soit entièrement visible <em>(les noms des personnages ne devraient pas être tronqués)</em>.
