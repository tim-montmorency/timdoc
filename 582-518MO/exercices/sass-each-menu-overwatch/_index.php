 ...
 */
?>
<p>Pour cet exercice vous devez recréer un menu permettant de choisir parmi certains personnages du jeu <a href="https://playoverwatch.com/fr-fr/">Overwatch</a>. Afin d’éviter de vous répéter, vous devrez tirer profit de la boucle <incode>@each</incode> de&nbsp;Scss.</p>
...
Faites-en sorte que l'élément avec la classe <incode>.overwatch</incode> soit centré verticalement ↕️ dans la page.
...
Utilisez une boucle <incode>@each</incode> afin de générer des noms de classes ciblant chacun des personnages suivants: <br><em>echo, genji, hanzo, junkrat, lucio, mccree, mercy, moira, orisa, pharah, reaper, reinhardt</em>
Pour chacun de ces personnages, ajouter une image d'arrière-plan dont le chemin de fichier correspond à: <br><incode>https://tim-montmorency.com/timdoc/582-518MO/exercices/sass-each-menu-overwatch/images/[nom du personnage].jpg</incode> <br>et assurez que cette image soit entièrement visible <em>(les noms des personnages ne devraient pas être tronqués)</em>.
