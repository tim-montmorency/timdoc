...
À chaque clic du bouton [+], vérifiez si l'année montrée dans la section <em>Quelle&nbsp;année&nbsp;de&nbsp;sortie?</em> est égale à l'année courante, si tel est le cas, changez la valeur de isCurrentYear à true. Profitez-en pour empêcher l'incrémentation de l'année affichée dans la section <em>Quelle&nbsp;année&nbsp;de&nbsp;sortie?</em> afin qu'elle ne continue pas à monter au delà de l'année courante.
Finalement, ajoutez la classe <span class='inline-code'>.disabled</span> au bouton [+] lorsque <span class='inline-code'>isCurrentYear</span> est à <span class='inline-code'>true</span>.
</checklist>
