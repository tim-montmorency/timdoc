...
Rendons la mixin plus polyvalente! Pour ce faire, elle doit accepter un argument (paramètre) correspondant au nombre de colonnes désirées comme largeur. <br><br>Par exemple, l'élément <code>.col-12</code> devrait passer le chiffre 12 en argument. 
