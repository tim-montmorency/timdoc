...
Rendons la mixin plus polyvalente! Pour ce faire, elle doit accepter un argument (paramètre) correspondant au nombre de colonnes désirées comme largeur. Par exemple, le chiffre 3 serait passé afin de recréer l'élément <code>.col-3</code>. Donnez une valeur de 1 par défaut à l'argument (paramètre) au cas ou la mixin serait appelée sans qu'il soit spécifié.<br><br>Plutôt que de donner une largeur de 100%, diviser le nombre de colonnes passé en argument (paramètre) par 12 <em>(nombre total de colonnes dans une grille Bootstrap)</em> et multipliez le par 100%. Votre colonne encadrée devrait maintenant avoir une largeur de 1 douzième, car aucun argument (paramètre) ne lui est actuellement passé. Corriger le tout en lui passant le nombre 12.
