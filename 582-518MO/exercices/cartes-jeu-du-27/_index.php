...
Afin de ne pas toujours afficher les mêmes 3 cartes, vous devez <strong>mélanger de façon aléatoire l'ordre des cartes</strong> dans tableau <incode>cardsValues</incode> en utilisant adéquatement l'<a target="_blank" onclick="event.stopPropagation()" rel="noopener noreferrer" href="../../javascript/objet-array">objet Array</a>. Puisque les 3 premières cartes du tableau varient, vous devriez maintenant avoir des cartes aléatoires au clic du bouton <em>"Commencez"</em>.
