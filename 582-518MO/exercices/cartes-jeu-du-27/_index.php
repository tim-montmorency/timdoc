...
<checklist>
Stockez tous les éléments qui contiennent la classe <code>.card</code> dans une variable.
Bouclez ensuite sur chacun de ces éléments et attribuez-leur la classe <code>.noX</code> où <code>X</code> représente un nombre de 1 à 3 basé sur l'index courant de la boucle. Ceci devrait faire apparaitre l'as <em>(1)</em>, le 2 et le 3 de carreau ♦️.
Déplacez maintenant votre boucle de sorte qu'elle se produise uniquement lorsque le bouton <em>"Commencez"</em> est cliqué.
Plutôt que de vous baser directement sur l'index d'itération de la boucle afin d'afficher les cartes, utilisez les valeurs dans le tableau <code>cardsValues</code> afin d'afficher les 3 premières valeurs. 
Afin de ne pas toujours afficher les mêmes 3 cartes, vous devez <strong>mélanger de façon aléatoire l'ordre des cartes</strong> dans tableau <code>cardsValues</code> en utilisant adéquatement l'<a target="_blank" onclick="event.stopPropagation()" rel="noopener noreferrer" href="https://smnarnold.com/cours/javascript/objet-array">objet Array</a>. Puisque les 3 premières cartes du tableau varient, vous devriez maintenant avoir des cartes aléatoires au clic du bouton <em>"Commencez"</em>.
