...
Faites en sorte que votre boucle s'exécute que lorsque le bouton <em>"Commencez"</em> est cliqué.
Plutôt que de vous baser directement sur l'index d'itération de la boucle afin d'afficher les cartes, utilisez les valeurs dans le tableau existant <incode>cardsValues</incode> afin d'afficher les 3 premières valeurs de ce tableau (donc 13, 12 et 11). Suite à quoi, vous devriez voir le roi, la reine et le valet de carreau ♦️ affichés à l'écran.
Afin de ne pas toujours afficher les mêmes 3 cartes, vous devez <strong>mélanger de façon aléatoire l'ordre des cartes</strong> du tableau <incode>cardsValues</incode> en utilisant adéquatement l'<a target="_blank" onclick="event.stopPropagation()" rel="noopener noreferrer" href="../../javascript/objet-array">objet Array</a>. Puisque les 3 premières cartes du tableau varient, vous devriez maintenant avoir des cartes aléatoires au clic du bouton <em>"Commencez"</em>. <br> <img src="medias/3-prem-valeurs-de-cardsValues.png">
Assurez-vous qu'à chaque fois que le bouton <em>"Commencez"</em> est cliqué, que chaque carte ne contienne que les classes <em>"card"</em> et son numéro <em>(noX)</em> et non plusieurs numéros de carte, sinon l'affichage de la carte pourrait être erroné.<br><incode>🚫 div class="card no3 no6 no4"</incode>
