...
Plutôt que de vous baser directement sur l'index d'itération de la boucle afin d'afficher les cartes, utilisez les valeurs dans le tableau existant <incode>cardsValues</incode> afin d'afficher les 3 premières valeurs de ce tableau.
Afin de ne pas toujours afficher les mêmes 3 cartes, vous devez <strong>mélanger de façon aléatoire l'ordre des cartes</strong> du tableau <incode>cardsValues</incode> en utilisant adéquatement l'<a target="_blank" onclick="event.stopPropagation()" rel="noopener noreferrer" href="../../javascript/objet-array">objet Array</a>. Puisque les 3 premières cartes du tableau varient, vous devriez maintenant avoir des cartes aléatoires au clic du bouton <em>"Commencez"</em>.
