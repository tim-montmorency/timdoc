...
<ol>
  ...
  <li>Toujours dans phpMyAdmin, positionné sur votre nouvelle base de données fraîchement créée, importez votre fichier d'export (le fichier avec extension .sql).</li>
