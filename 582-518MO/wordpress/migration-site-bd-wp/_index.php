...
<alert>Si l'avant dernière étape retourne une erreur c'est que votre configuration MAMP n'est pas pareille à celle de l'école. Donc, le URL est différent. Ainsi, à la place de <span class='inline-code'>localhost:81/abc</span>, il est souvent possible que votre url n'affiche que <span class='inline-code'>localhost/abc</span>. Pour remédier à ce problème, vous devez ouvrir phpMyAdmin, ouvrir la table <em>wp-options</em> et éditer <em>siteurl</em> avec le url de votre installation actuelle. Vous devez aussi faire la même chose pour <em>home</em> (dans la même table).</alert>


<warning>Autre problème possible: votre navigateur vous retourne toujours vers <span class='inline-code'>localhost:81/abc</span> même si vous tappez <span class='inline-code'>localhost/abc</span>. Si tel est le cas, vous devez vider la cache de votre navigateur. Pour développer votre débrouillardise, je vous laisse trouver comment le faire, vous avez les outils pour trouver.</warning>
