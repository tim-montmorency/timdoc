...
<p>La déclaration d'un nouveau type de posts doit se fait via le fichier&nbsp;<code>functions.php</code>.</p>
...
<p>Dans cet exemple, avec&nbsp;<code>'labels' =&gt; array( ... )</code>&nbsp;indique à WordPress comment nommer ce nouveau post dans différents&nbsp;scénarios.</p><p><code>'supports' =&gt; array( ... )</code>&nbsp;indique les champs disponibles pour ce type de post dans le tableau de&nbsp;bord.</p><p>Tandis que&nbsp;<code>addaction('init', 'createpost_type');</code>&nbsp;indique à WordPress d'appeler cette fonction créant le nouveau type de post à son&nbsp;instanciation.</p><p>Dès ce moment, la nouvelle collection devrait être disponible dans le tableau de&nbsp;bord.</p>
...
<ol start="1">
    <li><p><em>Slug</em>&nbsp;nom pour accéder au post dans le&nbsp;code</p></li>
    <li><p><em>Plural Label</em>&nbsp;nom au pluriel des&nbsp;posts</p></li>
    <li><p><em>Singular Label</em>&nbsp;nom au singulier des&nbsp;posts</p></li>
</ol>
...
<ol start="1">
    <li><p>Allez dans&nbsp;<code>Apparence -&gt; Menus</code>.</p></li>
...
<p>Pour ce faire, dans le fichier PHP d'un modèle, il faut ajouter dans les commentaires de début de page une propriété intitulée&nbsp;<code>Template Post Type</code>&nbsp;et lui spécifier les types de posts&nbsp;compatibles.</p>
...
<p>Il faut aller dans l'onglet&nbsp;<code>CPT UI</code>&nbsp;et sélectionner l'option&nbsp;<code>Tools</code>. À cet endroit dans la colonne de droite, une boite de texte permet de copier un code JSON contenant la structure des posts personnalisés. </p>
...
<p>Pour importer des posts personnalisés, il faut aussi aller dans l'onglet&nbsp;<code>CPT UI</code>&nbsp;et sélectionner l'option&nbsp;<code>Tools</code>. Sur cette page, dans la colonne de gauche, se trouve une boite de texte vide permettant de copier un code JSON. Importez le code désiré permet de recréer la structure des posts personnalisés d'un projet à un autre.</p>
