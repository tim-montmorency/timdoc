...
<p>Dans cet exemple, avec&nbsp;<code>'labels' =&gt; array( ... )</code>&nbsp;indique à WordPress comment nommer ce nouveau post dans différents&nbsp;scénarios.</p><p><code>'supports' =&gt; array( ... )</code>&nbsp;indique les champs disponibles pour ce type de post dans le tableau de&nbsp;bord.</p>

<p>Tandis que&nbsp;<code>addaction('init', 'createpost_type');</code>&nbsp;indique à WordPress d'appeler cette fonction créant le nouveau type de post à son&nbsp;instanciation.</p><p>Dès ce moment, la nouvelle collection devrait être disponible dans le tableau de&nbsp;bord.</p>
