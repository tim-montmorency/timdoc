...
<p>Sans extension ajoutée, Wordpress fontionne sous une struture définie. Cette base vous permet de manipuler différents contenus, les enregistrer dans sa base de données et les afficher dans vos pages web. Voici les types de contenu inclus dans le coeur (core) de WordPress:</p>
