...
<p>Pour afficher les <em>images mise en avant</em> (image principale du post) dans un modèle (template), il vous suffit, un peu comme <code>&lt;?php the_title();?&gt;</code> et  <code>&lt;?php the_content();?&gt;</code> d'appeler la fonction suivante:</p>

<highlight lang='php'>&lt;?php the_post_thumbnail(); ?&gt;</highlight>

<p>Cette fontion génèrera la balise <em>&lt;img&gt;</em> entière.</p>

<info>Notez que pour cela, il faudra que le fichier <em>function.php</em> de votre thème contienne la ligne suivante: <br> <code>add_theme_support( 'post-thumbnails' );</code></info>
<br>
...
<p>Le premier paramètre de <code>&lt;?php the_post_thumbnail(); ?&gt;</code> est le libellé de la taille désirée, soit:</p>
<highlight lang='php'>
...
<p>Pour ajouter la classe <code>.image-responsive</code> à la balise image générée, voici ce qu'on devrait ajouter: <code>array(&#39;class&#39; =&gt; &#39;image-responsive&#39;)</code>, comme dans l'exemple ci-dessous</p>

<highlight lang='php'>&lt;?php the_post_thumbnail(&#39;medium&#39;, array(&#39;class&#39; =&gt; &#39;image-responsive&#39;)) ?&gt;</highlight>

<p>Vous pouriez aussi ajouter d'autres paramètres tel que l'activation du chargement différé (lazy loading), en ajoutant un autre élément à votre tableau (array) nommé <code>'loading' => 'lazy'</code>. N'oubliez pas de séparer chaque élément du taleau (array) par une virgule!</p>
<doclink href='https://developer.wordpress.org/reference/functions/the_post_thumbnail/'>post thumbnail</doclink>
