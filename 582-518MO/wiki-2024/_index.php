...
<wiki-page name="Sem07.lundi" date="2024-10-07">
    ...
    <ol>
        ...
        <li>Par la suite, continuez d'avancer l'intégration des autres pages du projet (SCSS+HTML+JS). Voir votre tableau Trello et gardez toujours un oeil sur les <a href="https://tim-montmorency.com/timdoc/582-518MO/projet/requis-client/" target="_blank" rel="noopener noreferrer">requis client</a>de chaque page pour ne rien oublier. </li>
    </ol>   
