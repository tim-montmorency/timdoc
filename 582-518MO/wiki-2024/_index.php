...
<wiki-page name="Sem05.lundi" date="2024-09-23">
    ...
    <grostitre>Annonces</grostitre>
    <p style="color: var(--main-color);"><strong>> Horaire lundi prochain (30 sept)</strong></p>
    <ul>
        <li style="padding: 0; margin: 0;">examen gr AM : 9h50 à 13h25</li>
        <li style="padding: 0; margin: 0;">examen gr PM : 9h50 à 18h</li>
    </ul>

    <warning>Ceux qui ont droit à mesures d'assouplissement, faire la demande aujourd'hui dans col.net car minimum 7 jours avant. Ceux qui ont une extension de temps devront commencer le cours avant au SAA. À vous de décider si  vous faites l'examen complet au SAA ou seulement la partie avant 9h50. Si vous voulez bouger à la classe, quelqu'un du SAA devra vous escorter jusqu'à notre local à 9h50.</warning>
    ...
    <p>Demain mardi au trou à l'horaire: groupe d'étude avec tuteur: Maïk. <a href="https://www.cmontmorency.qc.ca/etudiants/services-aux-etudiants/aide-a-la-reussite/aide-techniques/centre-aide-integration-multimedia/?" target="_blank" rel="noopener noreferrer">Calendrier tutorat</a>.</p>
    ...
    <dots></dots>
    <grostitre>Révision des exercices de la semaine dernière</grostitre>
