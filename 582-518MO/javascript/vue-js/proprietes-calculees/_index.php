...
<p>Heureusement, les propriétés calculées permettent d'éviter de complexifier inutilement les templates en permettant de retirer toute expression logique de ceux-ci. </p>

<p>Par exemple, la donnée suivante 👇 exprime clairement que l'information affichée correspond à un montant convertit en dollars américains 🇺🇸. Aucune expression mathématique ne vient polluer le template:</p>
...
<aside class="exercice-card">
    <div class="exercice-card__content">
      ...
      <a href="/exercices/vue/propriete-calculee-luchador" target="_blank" class="exercice-card__title">
