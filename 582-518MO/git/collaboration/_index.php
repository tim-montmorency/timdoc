...
?>
          ...
          <p>Git permet de travailler à plusieurs simultanément sur un même projet. Pour ce faire, chaque développeur possède une copie du même&nbsp;<em>repo</em>&nbsp;sur son ordinateur et partage un&nbsp;<em>repo commun</em>&nbsp;en ligne, généralement sur <a target="_blank" rel="noopener noreferrer" href="/cours/git/github">GitHub</a>, afin de pousser leurs&nbsp;<incode>commits</incode>.</p><p>Ainsi, à chaque fois qu'un développeur 👩 effectue un&nbsp;<incode>commit</incode>&nbsp;et le&nbsp;<incode>push</incode>&nbsp;en ligne, son collègue 👨 reçoit une notification sur son logiciel de suivi GIT, par exemple <a target="_blank" rel="noopener noreferrer" href="/cours/git/github-desktop">GitHub Desktop</a>, l'avertissant que de nouveaux changements sont disponibles et l'invite à effectuer un&nbsp;<incode>pull</incode>.</p><p>Ce dit collègue 👨 peut attendre avant de récupérer les changements et continuer à travailler /&nbsp;<incode>commiter</incode>&nbsp;à sa guise. Cependant, <strong>Git bloquera toute tentative de&nbsp;</strong><incode>push</incode><strong>&nbsp;tant qu'il n'aura pas&nbsp;</strong><incode>pullé</incode>&nbsp;les changements disponibles en&nbsp;ligne.</p>
