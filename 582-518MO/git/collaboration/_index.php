...
<p>Git permet de travailler à plusieurs simultanément sur un même projet. Pour ce faire, chaque développeur possède une copie du même&nbsp;<em>repo</em>&nbsp;sur son ordinateur et partage un&nbsp;<em>repo commun</em>&nbsp;en ligne, généralement sur <a target="_blank" rel="noopener noreferrer" href="../github/">GitHub</a>, afin de pousser leurs&nbsp;<incode>commits</incode>.</p

><p>Ainsi, à chaque fois qu'un développeur 👩 effectue un&nbsp;<incode>commit</incode>&nbsp;et le&nbsp;<incode>push</incode>&nbsp;en ligne, son collègue 👨 reçoit une notification sur son logiciel de suivi GIT, par exemple <a target="_blank" rel="noopener noreferrer" href="../github-desktop/">GitHub Desktop</a>, l'avertissant que de nouveaux changements sont disponibles et l'invite à effectuer un&nbsp;<incode>pull</incode>.</p>

<p>Ce dit collègue 👨 peut attendre avant de récupérer les changements et continuer à travailler /&nbsp;<incode>commiter</incode>&nbsp;à sa guise. Cependant, <strong>Git bloquera toute tentative de&nbsp;</strong><incode>push</incode><strong>&nbsp;tant qu'il n'aura pas&nbsp;</strong><incode>pullé</incode>&nbsp;les changements disponibles en&nbsp;ligne.</p>
...
<p>Bien qu'un&nbsp;<em>repo</em>&nbsp;soit public et que tous puissent le&nbsp;<a target="_blank" rel="noopener noreferrer" href="../github/#clone">cloner</a>, il est impossible pour quiconque de modifier la version sur GitHub, à moins d'en être l'auteur ou d'en avoir obtenu la permission préalablement.</p>

<p>Évidemment, dans le cadre d'un projet d'équipe, il est primordial de pouvoir donner la permission de modifier le <em>repo</em> à ses collègues. Pour ce faire, il suffit d'aller sur la page <a target="_blank" rel="noopener noreferrer" href="https://github.com/">GitHub</a> du repo que l'on désire partager et de cliquer sur ⚙️ <em>Settings</em>. Ensuite dans l'onglet&nbsp;<em>Manage access</em>, il est possible de cliquer sur&nbsp;<em>Invite a collaborator</em>&nbsp;et de rechercher le ou les collègues désirés par:</p>
...
<grostitre>Conflits 🤼‍♂️  </grostitre>
 ...
 <p>À moins de toujours travailler en solo, aucun développeur n'échappe à la problématique d'avoir modifié le même fichier que l'un de ses&nbsp;collègues.</p><p>Sans GIT, il n'était pas rare qu'un développeur remplace le fichiers d'un de ses collègues sans réaliser qu'il effaçait du même coups les progrès de celui-ci. Même en portant attention et en tentant de combiner manuellement chaque ligne de code des deux fichier, il était fréquent que des erreurs ou oublies se produisent.</p>
 
 <p>Heureusement GIT peut s'occuper de cette tâche pour nous! Puisque GIT surveille chaque changement dans un projet, il est en mesure de constater si un même fichier a été modifié par une autre personne depuis que nous avons commencer à le modifier. Le cas échéant, GIT sera même en mesure de dire si les lignes modifiées dans ce fichiers sont les mêmes.</p>
 
 <p>Autrement dit, si une autre personne a travaillé dans le même fichier depuis la dernière fois que nous l'avons tiré, mais que cette personne a travaillé sur des lignes différentes, GIT combinera les deux fichiers automatiquement sans que personne ne perde aucun progrès ✨.</p>
 
 <p>Si les lignes de code modifiées sont les mêmes, GIT créera alors ce que nous appelons un <em>"Conflit"</em>.</p>
