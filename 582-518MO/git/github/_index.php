...
<p>Le README sert à présenter un projet. Lorsque vous êtes sur la page d'accueil d'un répertoire, vous pouvez voir
    l'arborescence des fichiers le constituant suivis du README. Voici&nbsp;<a
        href="https://github.com/Tim-Momo/wordpress-theme-de-base">un exemple
        minimaliste</a>.</p>
...
<warning>Afin de simplifier/standardiser son affichage, son écriture ne se fait pas en HTML/CSS, mais en&nbsp;<a
                href="https://www.markdownguide.org/">Markdown</a>.</warning>
...
<p>Parfois certains fichiers ne sont simplement pas pertinents au projet en soi. Par exemple, lors de la création d'un
    ...
    le&nbsp;<a href="https://wordpress.org/download/">site officiel de
...
<aside class="tool-card">
    <div class="tool-card__content">
        ...
        <a href="https://github.com/github/gitignore" target="_blank"
            rel="noopener noreferrer" class="tool-card__title">
            <strong>Collection de&nbsp;.gitignore</strong>
        </a>

        <p class="tool-card__description">Collection de gabarits de base .gitignore adaptés à différents types
            de&nbsp;projets.</p>
    </div>
...
<aside class="tool-card">
    <div class="tool-card__content">
        ...
        <a href="https://choosealicense.com/" target="_blank"
            rel="noopener noreferrer" class="tool-card__title">
            <strong>Choose an open source&nbsp;license</strong>
        </a>

        <p class="tool-card__description">Conseils sans jugement sur le choix d’une licence pour votre projet
            open&nbsp;source</p>
    </div>
...
<p>Néanmoins, GitHub étant le plus grand hébergeur de code source au monde&nbsp;(<a
        href="https://fr.wikipedia.org/wiki/GitHub">50&nbsp;millions
