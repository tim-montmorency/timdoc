...
<p>Permet de définir indépendamment la taille de chaque colonne d'une grille. Le nombre de colonnes correspond au nombre de valeurs spécifiées.</p><p>Par exemple, trois valeurs produisent trois colonnes:</p>
...
<p>Permets de définir indépendamment la taille de chaque rangée d'une grille. Le nombre de rangées correspond au nombre de valeurs spécifiées.</p>
