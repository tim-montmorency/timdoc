...
<p>Ces propriétés peuvent être combinées en utilisant simplement <code>grid-column</code>. </p>
...
<p>La propriété <code>grid-row</code> est constituée de deux sous propriétés: <code>grid-row-start</code> et <code>grid-row-end</code>. Ces propriétés permettent de définir où un élément devrait être affiché en fonction d'une ligne horizontale ↔️ de départ et de fin dans la grille.</p>
...
<p>Ces propriétés peuvent être combinées en utilisant simplement <code>grid-row</code>. </p>
...
<p>La valeur <code>span</code> combinée aux propriétés <code>grid-column</code> &amp; <code>grid-row</code> permet d'étendre un élément sur plus d'une d'une colonne ou une rangée dans une grille sans avoir à connaitre le numéro de ligne de début ou de fin.</p>
...
<grostitre>grid-area</grostitre>
 <p>La propriété <code>grid-area</code> permet de définir à la fois la valeur de &nbsp;<code>grid-row-start</code>,&nbsp;<code>grid-column-start</code>,&nbsp;<code>grid-row-end</code> et&nbsp;<code>grid-column-end</code>.</p><p>Par exemple le code suivant:</p>
...
<p>La propriété <code>grid-template-areas</code> permets de nommer des zones dans une grille. Cette approche permet de conceptualiser facilement la disposition des éléments.</p>

<p>Par exemple, si l'élément vert 🟢 représente un menu latéral, l'élément bleu 🔵 le contenu principal et l'élément rouge 🔴 un pied de page, il serait possible de les distribuer dans une grille grâce à <code>grid-area</code>:</p>
...
<p></p>
<alert><em class="note__tagline">Erreur fréquente</em><br><code>grid-template-areas</code> prend un <em>"s"</em> à la&nbsp;fin.</alert>
