...
Créez les modèles suivants à partir de <incode>about.php</incode>: <br> -home.php<br> -news-hub.php<br> -news-article.php<br> -services-hub.php<br> -service.php<br> -team.php<br> -about.php <em>(déjà présent)</em><br> -history.php<br> -faq<br> -404.php <em>(déjà présent)</em>
...
Créez la base de données via le WP ToolKit et assurez vous que le nom d'utilisateur et mot de passe pour la base de données sont confidentiel, complexes et non seulement <em>root</em> comme vous l'avez fait en local (n'oubliez pas de les noter quelque part).
...
Créez un compte administrateur dans Wordpress pour votre client (moi) avec l’adresse courriel de l'enseignante que vous pouvez trouver dans le plan de cours.
