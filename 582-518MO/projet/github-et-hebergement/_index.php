...
<checklist>Créez répertoire <a target="_blank" onclick="event.stopPropagation()" rel="noopener noreferrer" href="https://github.com/">GitHub</a> et nommez le <incode>[Nom du client]-[Nom de l'équipe]</incode>.<br>ex: <em>craque-bitume-les-casseroles-bruyantes</em>
