...
<alert>Attention, le pointage que vous voyez <em>en jaune</em> sur chaque requid ci-bas va être révisé d'ici jeudi prochain car je suis en révision de l'évaluation totale du projet. Ceci étant dit, ça vous donne quand même une petite idée du poids de chaque requis sur l'évaluation finale. Le tout vous sera expliqué jeudi prochain.</alert>
