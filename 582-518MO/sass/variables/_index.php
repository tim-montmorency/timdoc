...
<p>Par&nbsp;exemple, on pourrait supposer que de base, tous les personnages ont un costume rouge et qu'après on peut gérer les exceptions en écransant la valeur de la variable <code>$costume</code> localement pour un personnage spécifique: Green Goblin. </p>
...
<p>Dans cet exemple, la variable&nbsp;<code>$costume</code>&nbsp;à la valeur&nbsp;<code>red</code>&nbsp;dans le contexte global. Ainsi, si un personnage n'écrase pas cette variable, son costume sera automatiquement rouge 🔴. Tandis que
    le sélecteur&nbsp;<code>.green-goblin</code>&nbsp;redéfinit la valeur de cette variable dans son propre contexte
    à&nbsp;<code>green</code> 🟢.</p>

<warning>Même si un personnage est défini après <code>.green-goblin</code>, s’il utilise la variable <code>$costume</code>, celle-ci retournera <code>red</code>, car la valeur <code>green</code> n’est retournée qu’à l’intérieur du contexte du sélecteur&nbsp;<code>.green-goblin</code>.</warning>
...
<p>Par exemple, si vous inspectez la balise&nbsp;<code>&lt;html&gt;</code>&nbsp;de cette page (clic-droit / Inspecter / Sélectionnez <code>&lt;html lang="fr-ca"&gt;</code>). Vous remarquerez que
