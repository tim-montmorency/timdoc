...
<p>Il convient grouper dans un même <em>partial</em> des mixins vont bien ensemble, par exemple des styles de modification d'image. <a href="https://www.w3schools.com/css/css3_images.asp" target="_blank" rel="noopener noreferrer">Voici quelques exemples</a> de styles de modifications d'une image à partir desquels vous pourriez créer des mixins. </p>
