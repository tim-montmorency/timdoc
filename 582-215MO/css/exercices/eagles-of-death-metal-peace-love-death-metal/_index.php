...
<checklist>
  ...
  L'album doit avoir une dimension verticale et honrizontale de <em>80%</em> du plus petit côté de la fenêtre, être de couleur <em>bleue</em> ainsi qu'avoir un ombrage égal de tous les côtés de couleur <em>blanche</em>.
...
<checklist>
  Lorsque survolés, les éléments <span class="inline-code">.hand</span> doivent grossir jusqu'a un facteur de <em>150%</em> et faire une rotation de <em>720deg</em> en <em>1 seconde</em>.
...
<clip src="./videos/eagles-of-death-metal-i-only-want-you.mp4"></clip>
