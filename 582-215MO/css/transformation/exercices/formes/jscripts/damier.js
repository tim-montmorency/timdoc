var popup = new AppendPopup({
    ...
    text: "Félicitation, vous maîtrisez le damier",
    color: "#A0CFD3",
    background: "https://i.giphy.com/media/25R4M20McMDhqlb5U3/giphy.webp",
...
body {
    ...
    background-image: url(https://tim-montmorency.com/timdoc/582-215MO/css/transformation/exercices/formes/images/damier.png);
...
var validate = debounce(function () {
    ...
    if(s1) {
        var s2 = validateSlide(blue, '0', '0', 0, '1', '1');
        if(s2) {
            var s3 = validateSlide(green, '-200', '-200', 0, '1', '1');
            if(s3) {
