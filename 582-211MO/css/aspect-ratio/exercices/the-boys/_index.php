...
<checklist>
    Créez le ruban à l'aide de l'élément <span class="inline-code">.ribbon</span>. Celui-ci doit-être affiché au bas de la page complètement ⬇️, afficher la tuile en pièce jointe comme arrière-plan se répétant à l'infini. Prendre toute la largeur de la page et avoir une hauteur équivalente au quart de sa hauteur, peu importe la dimension de la fenêtre.
    L'affiche doit mesurer 80% de la hauteur de la page, jusqu'à un maximum de 500px. Il doit avoir une marge de 25px vers le haut et le bas et être centré horizontalement dans la page ↔️. Ajoutez-lui une bordure rouge 🔴 de 20px ainsi qu'une ombre noire ⚫️ de 50px, répartie également de chaque côté.
