...
<ul>
  <li>
    <incode>none</incode> par défaut.
  </li>
  <li>
    <incode>blur()</incode> <em>(flou)</em> Valeur acceptant toutes les unités de mesure
  </li>
  <li>
    <incode>brightness()</incode> <em>(luminosité)</em> valeur en pourcentage
  </li>
  <li>
    <incode>contrast()</incode> <em>(contraste)</em> valeur en pourcentage
  </li>
  <li>
    <incode>drop-shadow()</incode> <em>(ombre portée)</em> même format que box-shadow
  </li>
  <li>
    <incode>grayscale()</incode> <em>(niveau de gris)</em> valeur en pourcentage
  </li>
  <li>
    <incode>hue-rotate()</incode> <em>(rotation de la teinte)</em> valeur en degrés
  </li>
  <li>
    <incode>invert()</incode> <em>(inverser)</em> valeur en pourcentage
  </li>
  <li>
    <incode>opacity()</incode> <em>(opacité)</em> valeur en pourcentage
  </li>
  <li>
    <incode>saturate()</incode> <em>(saturation)</em> valeur en pourcentage
  </li>
  <li>
    <incode>sepia()</incode> <em>(sépia)</em> valeur en pourcentage
  </li>
  <li>etc.</li>
</ul>
...
<p>La propriété <incode>backdrop-filter</incode> permet elle aussi d'ajouter des effets visuels, mais uniquement entre un élément et son arrière-plan. Il est donc nécessaire que l'élément en question ne soit pas entièrement opaque afin de pouvoir voir une partie de l'élément arrière-plan.</p>
