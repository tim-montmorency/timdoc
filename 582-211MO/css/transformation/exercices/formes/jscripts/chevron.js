var popup = new AppendPopup({
    ...
    text: "Félicitation, vous maîtrisez les skews",
    color: "#ae00ff",
    background: "https://media3.giphy.com/media/Ss0j0kev4Qp4GW59xn/giphy.gif?cid=790b7611aa179e215b4a949fe3fd04bc59c625e84c59e656&rid=giphy.gif",
...
body {
    ...
    background-image: url(https://tim-montmorency.com/timdoc/582-215MO/css/transformation/exercices/formes/images/chevron.png);
}
.slide {
    width: 200px;
    height: 200px;
...
var validate = debounce(function () {
    var s1 = validateSlide(red, '-100', '-300', 20, '1.0', '1.4');
    if(s1) {
        var s2 = validateSlide(blue, '-100', '-100', 20, '1.0', '1.4');
        if(s2) {
            var s3 = validateSlide(green, '-100', '100', 20, '1.0', '1.4');
            if(s3) {
